...
exports.FindUniqueClassroomResolver = void 0;
...
let FindUniqueClassroomResolver = class FindUniqueClassroomResolver {
...
], FindUniqueClassroomResolver.prototype, "classroom", null);
FindUniqueClassroomResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Classroom_1.Classroom)
], FindUniqueClassroomResolver);
exports.FindUniqueClassroomResolver = FindUniqueClassroomResolver;
