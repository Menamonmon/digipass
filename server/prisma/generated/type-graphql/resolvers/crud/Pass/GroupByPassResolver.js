...
exports.GroupByPassResolver = void 0;
...
let GroupByPassResolver = class GroupByPassResolver {
...
], GroupByPassResolver.prototype, "groupByPass", null);
GroupByPassResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Pass_1.Pass)
], GroupByPassResolver);
exports.GroupByPassResolver = GroupByPassResolver;
