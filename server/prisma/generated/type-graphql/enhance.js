...
const modelsInfo = {
    ...
    IPAddress: ["ownerId", "id", "createdAt", "address"],
...
const outputsInfo = {
    ...
    IPAddressGroupBy: ["ownerId", "id", "createdAt", "address", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    IPAddressCountAggregate: ["ownerId", "id", "createdAt", "address", "_all"],
    IPAddressAvgAggregate: ["ownerId", "id"],
    IPAddressSumAggregate: ["ownerId", "id"],
    IPAddressMinAggregate: ["ownerId", "id", "createdAt", "address"],
    IPAddressMaxAggregate: ["ownerId", "id", "createdAt", "address"],
...
const inputsInfo = {
    ...
    IPAddressWhereInput: ["AND", "OR", "NOT", "owner", "ownerId", "id", "createdAt", "address"],
    IPAddressOrderByWithRelationInput: ["owner", "ownerId", "id", "createdAt", "address"],
    IPAddressWhereUniqueInput: ["id"],
    IPAddressOrderByWithAggregationInput: ["ownerId", "id", "createdAt", "address", "_count", "_avg", "_max", "_min", "_sum"],
    IPAddressScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "ownerId", "id", "createdAt", "address"],
    ...
    IPAddressCreateManyInput: ["ownerId", "id", "createdAt", "address"],
    ...
    IPAddressCountOrderByAggregateInput: ["ownerId", "id", "createdAt", "address"],
    IPAddressAvgOrderByAggregateInput: ["ownerId", "id"],
    IPAddressMaxOrderByAggregateInput: ["ownerId", "id", "createdAt", "address"],
    IPAddressMinOrderByAggregateInput: ["ownerId", "id", "createdAt", "address"],
    IPAddressSumOrderByAggregateInput: ["ownerId", "id"],
    ...
    StudentUpdateOneRequiredWithoutIpAddressesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ...
    TeacherUpdateOneRequiredWithoutClassroomsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ...
    StudentUpdateOneRequiredWithoutPassesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ClassroomUpdateOneRequiredWithoutPassesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    TeacherUpdateOneRequiredWithoutIssuedPassesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ...
    IPAddressScalarWhereInput: ["AND", "OR", "NOT", "ownerId", "id", "createdAt", "address"],
