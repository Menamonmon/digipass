...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="mt-10">
        <h1 className="text-center">cleaner, faster, smarter: <span className="text-[#4f8ed8]">digipass</span> hall passes</h1>
        <div className="text-center m-20">
          ...
          <div className="flex flex-row gap-10 my-10">
                {infoItems.map((items, key) => (
                    <div className="w-full rounded-lg shadow-md lg:max-w-sm bg-[#4f8ed8] flex flex-col items-center p-5" key={key}>
                        {items.img}
      ...
      <h5 className="text-center">Powered by: Mena Filfil, Mannendri Olivares, Michael Sun, Brios Olivares, & Michael Tesfaye.</h5>
    </>
  );
};
